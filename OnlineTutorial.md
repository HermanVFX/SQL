...
- [Объединение запросов, оператор Union](#Объединение_запросов_оператор_Union)
- [Числовой тип данных](#Числовой_тип_данных)
- [Работа с датами и временем](#Работа_с_датами_и_временем)
____
...
```
____
## <a name="Объединение_запросов_оператор_Union">Объединение запросов, оператор Union</a>
### 1. Отчёт по тратам
...
```
____
## <a name="Числовой_тип_данных">Числовой тип данных</a>

### 1. Округление значений
...
```
____
## <a name="Работа_с_датами_и_временем">Работа с датами и временем</a>

### 1. Вывести текущую дату
Вывести текущую дату в формате ГГГГ-MM-ДД. Для вывода даты используйте псевдоним date.
```SQL
SELECT CONCAT(YEAR(now()), "-", MONTH(now()), "-", DAY(now())) AS date;
```
### 2. Вывести возраст всех членов семьи
